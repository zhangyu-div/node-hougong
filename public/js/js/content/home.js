class Home{
    ...
    setECharts(){
        var myChartone = echarts.init(document.getElementById('topone'));
        var myCharttwo = echarts.init(document.getElementById('toptwo'));
        var myChartthree = echarts.init(document.getElementById('topthree'));
        var myChartfour = echarts.init(document.getElementById('topfour'));
        var myChartfive = echarts.init(document.getElementById('topfive'));
...
var optionfive = {
    ...
    xAxis: {
        data: ['慈禧', '龙妈', '安琪拉', '盾山', '伽罗', '露娜', '小燕子', '小千峰', ],
        axisTick: {show: false},
        axisLine: {show: false},
        axisLabel: {
            textStyle: {
